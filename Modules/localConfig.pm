...
our @ISA=qw(Exporter);
our @EXPORT=qw($bwa $picard $samtools $GATK $cutadapt $fastqc $java $toggle $fastxTrimmer $tophat2 $bowtie2Build $bowtieBuild $htseqcount $stacks $transabyss);
...
#path for transabyss
our $transabyss = "/usr/local/transabyss-1.5.3/transabyss";
